/* Name: Eric Grounds
 * Date: 1-24-2013
 * Source File: /usr/src/servers/is/dmp.c
 * Changes Made: Changed the F4 key press (line 31) from executing privileges_dmp 
 *  		 to executing messagecount_dmp.
 */
...
struct hook_entry {
	...
	{ F4,   messagecount_dmp, "Message count" },  
